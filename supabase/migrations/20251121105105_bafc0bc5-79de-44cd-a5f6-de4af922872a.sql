-- Fix get_available_slots: use generate_series with timestamp arguments instead of interval
...
BEGIN
  ...
  time_slots AS (
    ...
    CROSS JOIN LATERAL generate_series(
      timestamp '2000-01-01' + av.start_time,
      timestamp '2000-01-01' + av.end_time - v_slot_duration,
      '15 minutes'::interval
    ) AS s
